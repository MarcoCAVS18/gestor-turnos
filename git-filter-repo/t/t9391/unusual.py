...
total_objects = ***REMOVED***'common': 0, 'uncommon': 0***REMOVED***
...
print("Found ***REMOVED******REMOVED*** blobs/commits and ***REMOVED******REMOVED*** other objects"
...
def look_for_reset(obj, metadata):
  print("Processing ***REMOVED******REMOVED***".format(obj))
  counts[type(obj)] += 1
  if type(obj) == fr.Reset:
...
filter.run()
assert counts == collections.Counter(***REMOVED***fr.Blob: 1, fr.Commit: 3, fr.Reset: 1***REMOVED***)
