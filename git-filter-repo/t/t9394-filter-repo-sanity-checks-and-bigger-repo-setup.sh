...
setup_metasyntactic_repo() ***REMOVED***
...
test_expect_success FUNNYNAMES '--dry-run' '
	...
	(
		...
		test_line_count = 2 out &&
		awk "***REMOVED***print \$1***REMOVED***" out | uniq >out2 &&
...
test_expect_success '--replace-text binary zero_byte-0_char' '
	(
		...
		OLD_CONTENT_FORMAT="$***REMOVED***OLD_STR***REMOVED***\\0$***REMOVED***OLD_STR***REMOVED***\\n0\\n"
		# expect content unchanged due to binary
		NEW_CONTENT_FORMAT="$***REMOVED***OLD_CONTENT_FORMAT***REMOVED***"

		rm -rf "$***REMOVED***REPO***REMOVED***"
		git init "$***REMOVED***REPO***REMOVED***"
		cd "$***REMOVED***REPO***REMOVED***"
		echo "$***REMOVED***OLD_STR***REMOVED***==>$***REMOVED***NEW_STR***REMOVED***" >../replace-rules
		printf "$***REMOVED***NEW_CONTENT_FORMAT***REMOVED***" > ../expect
		printf "$***REMOVED***OLD_CONTENT_FORMAT***REMOVED***" > "$***REMOVED***FILE***REMOVED***"
		git add "$***REMOVED***FILE***REMOVED***"
		git commit -m 'test'
		git filter-repo --force --replace-text ../replace-rules

		test_cmp ../expect "$***REMOVED***FILE***REMOVED***"
	)
'
...
test_expect_success '--replace-text text-file no_zero_byte-zero_char' '
	(
		...
		OLD_CONTENT_FORMAT="$***REMOVED***OLD_STR***REMOVED***0\\n0$***REMOVED***OLD_STR***REMOVED***\\n0\\n"
		# expect content changed due to text
		NEW_CONTENT_FORMAT="$***REMOVED***NEW_STR***REMOVED***0\\n0$***REMOVED***NEW_STR***REMOVED***\\n0\\n"
