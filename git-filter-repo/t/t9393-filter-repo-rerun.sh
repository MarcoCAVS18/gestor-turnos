...
test_expect_success 'a re-run that is treated as a clean slate' '
	...
	(
		...
		$***REMOVED***FIRST_ORPHAN***REMOVED*** $***REMOVED***FIRST_ORPHAN***REMOVED***
		$***REMOVED***FINAL_ORPHAN***REMOVED*** $***REMOVED***FINAL_ORPHAN***REMOVED***
		$***REMOVED***FILE_A_CHANGE***REMOVED*** $***REMOVED***FILE_A_CHANGE***REMOVED***
		$***REMOVED***FILE_B_CHANGE***REMOVED*** $***REMOVED***DELETED_SHA***REMOVED***
		$***REMOVED***FILE_C_CHANGE***REMOVED*** $***REMOVED***NEW_FILE_C_CHANGE***REMOVED***
		$***REMOVED***FILE_D_CHANGE***REMOVED*** $***REMOVED***NEW_FILE_D_CHANGE***REMOVED***
		EOF
		printf "%-40s %s\n" old new >expect &&
		...
		$***REMOVED***FILE_D_CHANGE***REMOVED*** $***REMOVED***NEW_FILE_D_CHANGE***REMOVED*** $(git symbolic-ref HEAD)
		$***REMOVED***FINAL_ORPHAN***REMOVED*** $***REMOVED***FINAL_ORPHAN***REMOVED*** refs/heads/orphan-me
		$***REMOVED***ORIGINAL_TAG***REMOVED*** $***REMOVED***FINAL_TAG***REMOVED*** refs/tags/v1.0
		EOF
		printf "%-40s %-40s %s\n" old new ref >expect &&
		cat sha-expect >>expect &&
		...
		cat <<-EOF | sort >expect &&
		$***REMOVED***FILE_B_CHANGE***REMOVED*** $***REMOVED***FILE_A_CHANGE***REMOVED***
		EOF
		...
		$***REMOVED***FINAL_ORPHAN***REMOVED*** $***REMOVED***FINAL_ORPHAN***REMOVED***
		$***REMOVED***FILE_A_CHANGE***REMOVED*** $***REMOVED***FILE_A_CHANGE***REMOVED***
		$***REMOVED***NEW_FILE_C_CHANGE***REMOVED*** $***REMOVED***DELETED_SHA***REMOVED***
		$***REMOVED***NEW_FILE_D_CHANGE***REMOVED*** $***REMOVED***FINAL_FILE_D_CHANGE***REMOVED***
		EOF
		printf "%-40s %s\n" old new >expect &&
		cat sha-expect >>expect &&
		test_cmp expect .git/filter-repo/commit-map &&
		...
		cat <<-EOF | sort -k 3 >sha-expect &&
		$***REMOVED***NEW_FILE_D_CHANGE***REMOVED*** $***REMOVED***FINAL_FILE_D_CHANGE***REMOVED*** $(git symbolic-ref HEAD)
		$***REMOVED***FINAL_ORPHAN***REMOVED*** $***REMOVED***FINAL_ORPHAN***REMOVED*** refs/heads/orphan-me
		$***REMOVED***FINAL_TAG***REMOVED*** $***REMOVED***REALLY_FINAL_TAG***REMOVED*** refs/tags/v1.0
		EOF
		printf "%-40s %-40s %s\n" old new ref >expect &&
		cat sha-expect >>expect &&
		test_cmp expect .git/filter-repo/ref-map &&
		...
		cat <<-EOF | sort >expect &&
		$***REMOVED***NEW_FILE_C_CHANGE***REMOVED*** $***REMOVED***FILE_A_CHANGE***REMOVED***
		EOF
		test_cmp expect .git/filter-repo/first-changed-commits
	)
'
...
test_expect_success 'remove two files, no re-run' '
	...
	(
		...
		cat <<-EOF | sort >sha-expect &&
		$***REMOVED***FIRST_ORPHAN***REMOVED*** $***REMOVED***DELETED_SHA***REMOVED***
		$***REMOVED***FINAL_ORPHAN***REMOVED*** $***REMOVED***DELETED_SHA***REMOVED***
		$***REMOVED***FILE_A_CHANGE***REMOVED*** $***REMOVED***FILE_A_CHANGE***REMOVED***
		$***REMOVED***FILE_B_CHANGE***REMOVED*** $***REMOVED***FILE_B_CHANGE***REMOVED***
		$***REMOVED***FILE_C_CHANGE***REMOVED*** $***REMOVED***DELETED_SHA***REMOVED***
		$***REMOVED***FILE_D_CHANGE***REMOVED*** $***REMOVED***NEW_FILE_D_CHANGE***REMOVED***
		EOF
		printf "%-40s %s\n" old new >expect &&
		cat sha-expect >>expect &&
		...
		cat <<-EOF | sort -k 3 >sha-expect &&
		$***REMOVED***FILE_D_CHANGE***REMOVED*** $***REMOVED***NEW_FILE_D_CHANGE***REMOVED*** $(git symbolic-ref HEAD)
		$***REMOVED***FINAL_ORPHAN***REMOVED*** $***REMOVED***DELETED_SHA***REMOVED*** refs/heads/orphan-me
		$***REMOVED***ORIGINAL_TAG***REMOVED*** $***REMOVED***NEW_TAG***REMOVED*** refs/tags/v1.0
		EOF
		printf "%-40s %-40s %s\n" old new ref >expect &&
		cat sha-expect >>expect &&
		test_cmp expect .git/filter-repo/ref-map &&
		...
		cat <<-EOF | sort >expect &&
		$***REMOVED***FIRST_ORPHAN***REMOVED*** $***REMOVED***DELETED_SHA***REMOVED***
		$***REMOVED***FILE_C_CHANGE***REMOVED*** $***REMOVED***FILE_B_CHANGE***REMOVED***
		EOF
		test_cmp expect .git/filter-repo/first-changed-commits
	)
'
...
test_expect_success 'remove two files, then remove a later file' '
	...
	(
		...
		$***REMOVED***FILE_B_CHANGE***REMOVED*** $***REMOVED***FILE_B_CHANGE***REMOVED***
		$***REMOVED***FILE_C_CHANGE***REMOVED*** $***REMOVED***DELETED_SHA***REMOVED***
		$***REMOVED***FILE_D_CHANGE***REMOVED*** $***REMOVED***DELETED_SHA***REMOVED***
		EOF
		printf "%-40s %s\n" old new >expect &&
		cat sha-expect >>expect &&
		test_cmp expect .git/filter-repo/commit-map &&
		...
		cat <<-EOF | sort -k 3 >sha-expect &&
		$***REMOVED***FILE_D_CHANGE***REMOVED*** $***REMOVED***FILE_B_CHANGE***REMOVED*** $(git symbolic-ref HEAD)
		$***REMOVED***FINAL_ORPHAN***REMOVED*** $***REMOVED***DELETED_SHA***REMOVED*** refs/heads/orphan-me
		$***REMOVED***ORIGINAL_TAG***REMOVED*** $***REMOVED***FINAL_TAG***REMOVED*** refs/tags/v1.0
		EOF
		printf "%-40s %-40s %s\n" old new ref >expect &&
...
test_expect_success 'remove two files, then remove a later file via --refs' '
	...
	(
		...
		cat <<-EOF | sort -k 3 >sha-expect &&
		$***REMOVED***FILE_D_CHANGE***REMOVED*** $***REMOVED***NEW_FILE_C_CHANGE***REMOVED*** $(git symbolic-ref HEAD)
		$***REMOVED***FINAL_ORPHAN***REMOVED*** $***REMOVED***DELETED_SHA***REMOVED*** refs/heads/orphan-me
		$***REMOVED***ORIGINAL_TAG***REMOVED*** $***REMOVED***FINAL_TAG***REMOVED*** refs/tags/v1.0
		EOF
		printf "%-40s %-40s %s\n" old new ref >expect &&
...
test_expect_success 'modify a file, then remove a later file via --refs' '
	...
	(
		...
		cat <<-EOF | sort >expect &&
		$***REMOVED***FILE_B_CHANGE***REMOVED*** $***REMOVED***NEW_FILE_B_CHANGE***REMOVED***
		EOF
		test_cmp expect .git/filter-repo/first-changed-commits &&
		...
		echo $***REMOVED***NEW_FILE_B_CHANGE***REMOVED*** >actual &&
		test_cmp expect actual &&
...
test_expect_success 'use --refs heavily with a rerun' '
	...
	(
		...
		cat <<-EOF | sort >expect &&
		$***REMOVED***FINAL_ORPHAN***REMOVED*** $***REMOVED***NEW_FINAL_ORPHAN***REMOVED***
		EOF
		test_cmp expect .git/filter-repo/first-changed-commits &&
		...
		cat <<-EOF | sort >expect &&
		$***REMOVED***FINAL_ORPHAN***REMOVED*** $***REMOVED***NEW_FINAL_ORPHAN***REMOVED***
		$***REMOVED***FILE_D_CHANGE***REMOVED*** $***REMOVED***FILE_C_CHANGE***REMOVED***
		EOF
		test_cmp expect .git/filter-repo/first-changed-commits &&
		...
		$***REMOVED***FILE_A_CHANGE***REMOVED*** $***REMOVED***FILE_A_CHANGE***REMOVED***
		$***REMOVED***FILE_B_CHANGE***REMOVED*** $***REMOVED***FILE_B_CHANGE***REMOVED***
		$***REMOVED***FILE_C_CHANGE***REMOVED*** $***REMOVED***FILE_C_CHANGE***REMOVED***
		$***REMOVED***FILE_D_CHANGE***REMOVED*** $***REMOVED***DELETED_SHA***REMOVED***
		EOF
		printf "%-40s %s\n" old new >expect &&
		cat sha-expect >>expect &&
		...
		cat <<-EOF | sort -k 3 >sha-expect &&
		$***REMOVED***FILE_D_CHANGE***REMOVED*** $***REMOVED***FILE_C_CHANGE***REMOVED*** $(git symbolic-ref HEAD)
		$***REMOVED***FINAL_ORPHAN***REMOVED*** $***REMOVED***NEW_FINAL_ORPHAN***REMOVED*** refs/heads/orphan-me
		EOF
		printf "%-40s %-40s %s\n" old new ref >expect &&
		cat sha-expect >>expect &&
		test_cmp expect .git/filter-repo/ref-map
