  ...
  return (
    <div style=***REMOVED***containerStyle***REMOVED***>
      ...
      >
        ...
        <circle className="circle" cx="295" cy="165" r="45" fill=***REMOVED***colorPrincipal***REMOVED*** />
        <circle className="circle" cx="420" cy="165" r="45" fill=***REMOVED***colorPrincipal***REMOVED*** />
        <circle className="circle" cx="545" cy="165" r="45" fill=***REMOVED***colorPrincipal***REMOVED*** />
      </svg>
    </div>
  );
***REMOVED***;
