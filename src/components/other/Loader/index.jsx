  ...
  return (
    <div className={getContainerClass()}>
      ...
      >
        ...
        <circle className="circle" cx="547" cy="250" r="45" fill={colorPrincipal} />
        <circle className="circle" cx="422" cy="250" r="45" fill={colorPrincipal} />
        <circle className="circle" cx="297" cy="250" r="45" fill={colorPrincipal} />
      </svg>
    </div>
  );
};
