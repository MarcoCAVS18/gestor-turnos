...
const Loader = ({ size = 65, fullScreen = false, onAnimationComplete }) => {
  ...
  return (
    <div style={containerStyle}>
      ...
      >
        {/* Path principal invertido horizontalmente */}
        <path 
          className="main-path"
        ...
        {/* Círculos también invertidos horizontalmente */}
        <circle className="circle" cx="547" cy="165" r="45" fill={colorPrincipal} />
        <circle className="circle" cx="422" cy="165" r="45" fill={colorPrincipal} />
        <circle className="circle" cx="297" cy="165" r="45" fill={colorPrincipal} />
      </svg>
    </div>
  );
};
