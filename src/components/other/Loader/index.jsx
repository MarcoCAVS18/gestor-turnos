// src/components/other/Loader/index.jsx - CORREGIDO

import React, ***REMOVED*** useEffect, useRef ***REMOVED*** from 'react';
import ***REMOVED*** useApp ***REMOVED*** from '../../../contexts/AppContext';
import ***REMOVED*** gsap ***REMOVED*** from 'gsap';

const Loader = (***REMOVED*** size = 65, fullScreen = false, onAnimationComplete ***REMOVED***) => ***REMOVED***
  ...
  ***REMOVED***;
  ...
  useEffect(() => ***REMOVED***
    ...
    ***REMOVED***, '-=0.4');
    ...
    tl.to(***REMOVED******REMOVED***, ***REMOVED*** duration: 2 ***REMOVED***);
  ...
  ***REMOVED***;
  ...
  return (
    <div style=***REMOVED***containerStyle***REMOVED***>
      ...
      >
        ***REMOVED***/* Path principal invertido horizontalmente */***REMOVED***
        <path 
          className="main-path"
        ...
        ***REMOVED***/* Círculos también invertidos horizontalmente */***REMOVED***
        <circle className="circle" cx="547" cy="165" r="45" fill=***REMOVED***colorPrincipal***REMOVED*** />
        <circle className="circle" cx="422" cy="165" r="45" fill=***REMOVED***colorPrincipal***REMOVED*** />
        <circle className="circle" cx="297" cy="165" r="45" fill=***REMOVED***colorPrincipal***REMOVED*** />
      </svg>
    </div>
  );
***REMOVED***;
