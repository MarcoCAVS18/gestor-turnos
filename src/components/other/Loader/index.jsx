...
const Loader = ({ size = 40, fullScreen = false, onAnimationComplete }) => {
  ...
  }, [primaryColor, onAnimationComplete]);
  ...
  return (
    <div className={getContainerClass()}>
      ...
      >
        ...
        {/* Circles with adjusted position to be visible */}
        <circle className="circle" cx="547" cy="250" r="45" fill={primaryColor} />
        <circle className="circle" cx="422" cy="250" r="45" fill={primaryColor} />
        <circle className="circle" cx="297" cy="250" r="45" fill={primaryColor} />
      </svg>
    </div>
  );
};
