...
const Loader = (***REMOVED*** size = 65, fullScreen = false, onAnimationComplete ***REMOVED***) => ***REMOVED***
  ...
  ***REMOVED***, [colorPrincipal, onAnimationComplete]);
  ...
  // Ajustar el tamaño según el prop size
  ...
  return (
    <div style=***REMOVED***containerStyle***REMOVED***>
      ...
      >
        ...
        ***REMOVED***/* Círculo izquierdo */***REMOVED***
        <circle 
          className="circle" 
          cx="295" 
          cy="165"
          r="45" 
          fill=***REMOVED***colorPrincipal***REMOVED*** 
        />
        
        ***REMOVED***/* Círculo central */***REMOVED***
        <circle 
          className="circle" 
          cx="420" 
          cy="165" 
        ...
        ***REMOVED***/* Círculo derecho */***REMOVED***
        <circle 
          className="circle" 
          cx="545" 
          cy="165" 
