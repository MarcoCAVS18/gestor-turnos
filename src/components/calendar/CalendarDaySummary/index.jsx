          ...
          >
            <Flex variant="between" className="flex items-center">
              ...
              <div className="flex items-center text-sm">
                ...
                <span className="mr-3">{safeShiftsOfDay.length} {safeShiftsOfDay.length === 1 ? t('common.shift') : t('common.shifts')}</span>
          ...
          {hasWorks ? (
            <>
              ...
              <p className="text-gray-500 mb-4">
                {t('calendarDaySummary.noShifts')} {
                  formatDate ? (
                    (() => {
                      const formattedDate = formatDate(selectedDate);
                      if (formattedDate.startsWith(t('calendar.today')) || formattedDate.startsWith(t('calendar.yesterday'))) {
                        return formattedDate;
                      }
                      return t('calendarDaySummary.theDate', { date: formattedDate });
                    })()
                  ) : t('calendarDaySummary.thisDate')
                }
              </p>
              <Button
            ...
            >
              ...
              <div className="text-center">
                <p className="font-medium text-gray-700 group-hover:text-gray-900">{t('works.addFirstJob')}</p>
                <p className="text-sm text-gray-500">{t('works.createToTrack')}</p>
              </div>
