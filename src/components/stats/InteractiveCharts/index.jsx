...
const InteractiveCharts = () => ***REMOVED***
  const ***REMOVED*** currentData, weeklyEvolutionData, thematicColors ***REMOVED*** = useStats();
  ...
  const workData = (currentData?.earningsByWork || [])
    .slice(0, 5)
    .map((work, index) => (***REMOVED***
      name: work.name.length > 12 ? `$***REMOVED***work.name.substring(0, 12)***REMOVED***...` : work.name,
      value: work.earnings,
  ...
  const dailyData = currentData?.earningsByDay
    ? Object.entries(currentData.earningsByDay).map(([day, data]) => (***REMOVED***
      ...
      case 0: // Weekly Evolution - LineChart
        return (
          <BaseChart
            ...
            chartType="line"
            dataKeys=***REMOVED***[***REMOVED*** key: 'earnings', stroke: chartConfigs.line.stroke ***REMOVED***]***REMOVED***
            nameKey="week"
            valueFormatter=***REMOVED***(value) => formatCurrency(value)***REMOVED***
            tooltipFormatter=***REMOVED***(value) => [formatCurrency(value), 'Earnings']***REMOVED***
      ...
      case 2: // Daily Hours - AreaChart
        return (
          <BaseChart
            ...
            chartType="area"
            dataKeys=***REMOVED***[***REMOVED*** key: 'hours', stroke: chartConfigs.area.stroke, fill: chartConfigs.area.fill ***REMOVED***]***REMOVED***
            nameKey="day"
            valueFormatter=***REMOVED***(value) => `$***REMOVED***value***REMOVED***h`***REMOVED***
            tooltipFormatter=***REMOVED***(value) => [`$***REMOVED***value.toFixed(1)***REMOVED*** hours`, 'Hours']***REMOVED***
