    ...
    <Card className="p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 flex items-center gap-2">
          ...
          {t('stats.vehicleEfficiency.title')}
        </h3>
        <div className="text-sm text-gray-500 dark:text-gray-400">{t('stats.vehicleEfficiency.costPerKm')}</div>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="text-gray-500 dark:text-gray-400">{t('stats.vehicleEfficiency.efficiency')}</p>
                  <p className="font-semibold text-gray-800 dark:text-gray-100">{stats.efficiency.toFixed(2)} {t('stats.vehicleEfficiency.kmPerDollar')}</p>
                </div>
                <div>
                  <p className="text-gray-500 dark:text-gray-400">{t('stats.vehicleEfficiency.totalSpent')}</p>
