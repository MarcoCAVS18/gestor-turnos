...
const DeliveryHourlyAnalysis = (***REMOVED*** shifts = [], className = "" ***REMOVED***) => ***REMOVED***
  ...
  ***REMOVED***, [weeklyHourlyStats]);
  ...
  const bestMoment = useMemo(() => ***REMOVED***
    let bestDay = null;
    let bestHour = null;
    let maxAvgProfit = 0;
      ...
      <Card className=***REMOVED***`flex flex-col $***REMOVED***className***REMOVED***`***REMOVED***>
        ...
        <div className="flex-grow flex flex-col items-center justify-center py-8 px-4">
          ...
          <Button onClick=***REMOVED***() => navigate('/turnos')***REMOVED*** variant="outline" themeColor=***REMOVED***colors.primary***REMOVED*** className="flex items-center gap-2 mt-4">
            <PlusCircle size=***REMOVED***16***REMOVED*** /> Add shift
          </Button>
        </div>
      </Card>
    );
  ...
  return (
    <Card className=***REMOVED***`flex flex-col $***REMOVED***className***REMOVED***`***REMOVED***>
      ...
      <div className="flex-grow flex flex-col space-y-6">
        ***REMOVED***/* Best Moment Card */***REMOVED***
        ***REMOVED***bestMoment.day !== null && bestMoment.averageProfitPerHour > 0 && (
            ...
            <Flex variant="between">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-yellow-100 rounded-full text-yellow-600">
                  <BestMomentIcon size=***REMOVED***24***REMOVED*** />
                </div>
                <div>
                  <p className="text-xs text-gray-500 uppercase font-bold tracking-wider">Best moment</p>
                  <p className="font-bold text-gray-800 text-lg">
                    ***REMOVED***bestMoment.day***REMOVED*** ***REMOVED***bestMoment.hour***REMOVED***:00 - ***REMOVED***bestMoment.hour + 1***REMOVED***:00
                  </p>
                </div>
              </div>
              <div className="text-right">
                <span className="text-2xl font-bold text-green-600">
                  ***REMOVED***formatCurrency(bestMoment.averageProfitPerHour)***REMOVED***
                </span>
