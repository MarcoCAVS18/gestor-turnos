          ...
          ***REMOVED***successMessage && (
          ...
          <form onSubmit=***REMOVED***handleLogin***REMOVED***>
            ...
            ***REMOVED***/* Enlace de recuperación de contraseña */***REMOVED***
            ...
            >
              ***REMOVED***loading ? "Cargando..." : "Continuar"***REMOVED***
            </button>
          </form>
          ...
          <button 
            ...
            disabled=***REMOVED***googleLoading***REMOVED***
            className="w-full flex items-center justify-center bg-black hover:bg-gray-800 text-white font-bold py-2 px-4 rounded mb-6"
          >
            ...
            ***REMOVED***googleLoading ? "Iniciando..." : "Continuar con Google"***REMOVED***
          </button>
