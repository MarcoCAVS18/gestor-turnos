      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2 pt-1">
          <button
            ...
            className="flex items-center justify-center gap-2 p-2.5 rounded-xl transition-colors text-sm font-medium"
            style={{ backgroundColor: colors.transparent10, color: colors.primary }}
            onMouseEnter={(e) => e.currentTarget.style.backgroundColor = colors.transparent20}
