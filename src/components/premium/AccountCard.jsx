  ...
  if (isPremium) {
    return (
      <Card variant="transparent" className="p-5 h-full">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">{t('premium.account')}</h2>
        <div className="flex flex-col items-center text-center">
          <div className="relative mb-3">
            ...
            >
              <img src={profilePhotoURL} alt={t('premium.profile')} className="w-full h-full object-cover" onError={(e) => { e.target.style.display = 'none'; }} />
            </div>
            <div
          ...
          {membershipDuration && (
            <div className="flex items-center gap-1.5 text-xs text-gray-400">
              ...
              <span>{t('premium.premiumFor', { duration: membershipDuration })}</span>
            </div>
          )}
        </div>
      </Card>
    ...
    <Card variant="transparent" className="p-5 h-full flex flex-col items-center justify-center text-center">
      <div className="relative mb-3">
        <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-gray-200">
          <img src={profilePhotoURL} alt={t('premium.profile')} className="w-full h-full object-cover" />
        </div>
      ...
      <p className="text-xs text-gray-400 mt-3">{t('premium.freePlan')}</p>
    </Card>
  );
};
